...
const MESSAGE_PAIRS = {
  ...
  'viewer.preset.veertu': ['Veertu', 'Veertu'],
  'viewer.preset.veertu.short': ['Veertu', 'Veertu'],
  'viewer.preset.veertu.hint': ['Anka / Veertu brand default', 'Anka / Veertu 品牌默认风格'],
  'viewer.preset.badge.veertu': ['VEERTU / ANKA', 'VEERTU / ANKA'],
  'viewer.preset.classic': ['Classic', '经典'],
  'viewer.preset.classic.short': ['Classic', '经典'],
  'viewer.preset.classic.hint': ['Stable technical console', '稳定的技术控制台风格'],
